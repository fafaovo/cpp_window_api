...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		{	
			...
			HWND hButton1 = CreateWindow(WC_BUTTON, _T("我是按钮1"), WS_CHILD | BS_PUSHBUTTON | WS_VISIBLE, 0, 20, 80, 40, hWnd, (HMENU)IDC_BUTTON_1, NULL, NULL);
			HWND hButton2 = CreateWindow(WC_BUTTON, _T("我是按钮2"), WS_CHILD | BS_PUSHBUTTON | WS_VISIBLE, 80, 20, 80, 40, hWnd, (HMENU)IDC_BUTTON_2, NULL, NULL);
		}	
		break;
		/*到此结束*/
		/*按钮点击事件创建*/
	case WM_COMMAND:
		{
				...
				if (nCode == BN_CLICKED)
				{
					...
					{
						index++;
						MessageBox(NULL, _T("第一个按钮被单击了"), _T("tip"), MB_OK);
					}
						
					if (nCtrIID == IDC_BUTTON_2)
						MessageBox(NULL, _T("第二个按钮被单击了"), _T("tip"), MB_OK);
				}
		}
		break;
	case WM_PAINT:
